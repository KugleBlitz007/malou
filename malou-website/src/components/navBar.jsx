...
<nav className="bg-white border-green-200 dark:bg-green-900">
  ...
  <div className="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
      ...
      <div className="z-50 hidden my-4 text-base list-none bg-white divide-y divide-green-100 rounded-lg shadow-sm dark:bg-green-700" id="language-dropdown-menu">
        <ul className="py-2 font-medium" role="none">
          <li>
            <a href="#" className="block px-4 py-2 text-sm text-green-700 hover:bg-green-100 dark:text-green-400 dark:hover:bg-green-600 dark:hover:text-white" role="menuitem">
          ...
          <li>
            <a href="#" className="block px-4 py-2 text-sm text-green-700 hover:bg-green-100 dark:text-green-400 dark:hover:bg-green-600 dark:hover:text-white" role="menuitem">
              <div className="inline-flex items-center">
              <img src="https://flagcdn.com/w40/fr.png" className="w-5 h-5 rounded-full mr-3" alt="French Flag" />
              Français {' '}
              </div>
            </a>
          </li>
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-green-100 rounded-lg bg-green-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-green-800 md:dark:bg-green-900 dark:border-green-700">
      <li>
        <a href="#" className="block py-2 px-3 text-white bg-green-700 rounded-sm md:bg-transparent md:text-green-700 md:p-0 md:dark:text-green-500" aria-current="page">Home</a>
      </li>
      <li>
        <a href="#" className="block py-2 px-3 md:p-0 text-green-900 rounded-sm hover:bg-green-100 md:hover:bg-transparent md:hover:text-green-700 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-green-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-green-700">About</a>
      </li>
      <li>
        <a href="#" className="block py-2 px-3 md:p-0 text-green-900 rounded-sm hover:bg-green-100 md:hover:bg-transparent md:hover:text-green-700 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-green-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-green-700">Services</a>
      </li>
      <li>
        <a href="#" className="block py-2 px-3 md:p-0 text-green-900 rounded-sm hover:bg-green-100 md:hover:bg-transparent md:hover:text-green-700 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-green-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-green-700">Pricing</a>
      </li>
      <li>
        <a href="#" className="block py-2 px-3 md:p-0 text-green-900 rounded-sm hover:bg-green-100 md:hover:bg-transparent md:hover:text-green-700 dark:text-white md:dark:hover:text-green-500 dark:hover:bg-green-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-green-700">Contact</a>
      </li>
    </ul>
  </div>
  </div>
