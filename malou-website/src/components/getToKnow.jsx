  ...
  return (
    <section className="max-w-screen-xl mx-auto px-4 py-8 bg-green-900" >
        ...
        <div class="flex justify-center">
            <a href="#" class="flex justify-left text-white text-center bg-green-700 hover:bg-green-600 focus:ring-4 focus:ring-blue-300 font-medium text-sm px-5 py-2.5 focus:outline-none">
            Read more

                <svg class="m-0.5 flex justify-right w-4 h-4 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
