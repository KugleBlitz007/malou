    ...
    <div>
       <NavBar />
        ...
        <div className="flex flex-col items-center justify-center h-screen bg-white">
          <h1 className="text-4xl font-bold text-green-900 mb-4">404 - Page non trouvée</h1>
          <p className="text-lg text-gray-700 mb-8">Désolé, la page que vous recherchez n'existe pas.</p>
