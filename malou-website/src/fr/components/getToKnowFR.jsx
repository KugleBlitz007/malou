...
export default function getToKnow() {
  return (
    <section className="max-w-screen-xl mx-auto px-4 py-8 bg-green-900" >
        <p className="text-3xl font-bold text-center text-white">Malagasy à uOttawa (MALOU)</p>

        <br></br>

        <p className="text-2xl text-center text-white"> est une association étudiante vibrante et accueillante, 
          dédiée à la promotion de la culture malgache et à la mise en valeur de Madagascar au sein de l’Université d’Ottawa. 
          Nous organisons des événements 
          culturels, des ateliers interactifs et des activités festives qui célèbrent la diversité, la francophonie et 
          la solidarité. Chez MALOU, chacun trouve un espace pour se sentir chez soi, échanger et s’épanouir, que vous 
          soyez Malgache ou simplement curieux d’en apprendre plus sur notre île. Venez rencontrer une communauté chaleureuse, 
          tisser des liens et célébrer Madagascar avec nous!  </p>

        <br></br>


        <div className="flex justify-center">
            <Link to ="/fr/AboutUs" className="flex justify-left text-white text-center bg-green-700 hover:bg-green-600 focus:ring-4 focus:ring-blue-300 font-medium text-sm px-5 py-2.5 focus:outline-none">
